  ...
  <br><br><br>
   ...
   <!-- <div class="row">
       ...
       <!-- <div class="row"> -->
         <div class="container FlowFlex">
           <div class="col-lg-6 col-sm-6" data-aos="fade-right"data-aos-offset="300"data-aos-easing="ease-in-sine">
             <div class="single_history_content">
               ...
               <h2 class="textHead"><span>Flowchart of <br> FSSAI Registration</span></h2>
             </div>
         ...
         <div class="col-lg-6 col-sm-6"><img class="flow" src="images1/FSSAI-Registration-Process-1024x761.png" alt="FSSAI-Registration-Process" data-aos="fade-left"data-aos-offset="300"data-aos-easing="ease-in-sine">
