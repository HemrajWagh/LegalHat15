      ...
      <section class="info">
         <div class="container">
             <h2 class="txtshadow num" style="color: #ffb900;text-align: center;">Awards & Achievement <br> "Elevating success to new heights" </h2>
         </div>
...
<br><br>
      <section id="about" class="about roomy-100" style="background-image: url(images1/BK.jpg);">
        ...
        <div class="container">
          <div class="row"id="parallex2"  >    
            <div class="col-lg-12" style="display:flex; flex-direction: column; align-items: center;justify-content: center; ">
              <!-- <h1>What We Do?</h1> -->
              <!-- Section's title goes here -->
              <h5 style="color:#ffb900;margin-top:50px;">DIFFERENT TYPES OF TRADEMARKS THAT CAN BE REGISTERED IN INDIA</h5>
              <hr class="new1">
