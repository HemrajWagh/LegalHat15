...
<nav class="navbar navbar-expand-lg navbar-light bg-light bg-transparent" id="gtco-main-nav">
    <div class="container"><a class="navbar-brand">My</a>
...
<div class="container-fluid gtco-banner-area">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card"><img class="card-img-top img-fluid" src="images1/banner-img.png" alt=""></div>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid gtco-testimonials">
    <div class="container">
        ...
        <div class="owl-carousel owl-carousel1 owl-theme">
            <div>
                <div class="card text-center"><img class="card-img-top" src="images1/customer1.jpg" alt="">
                    <div class="card-body">
                        <h5>Lisa Gally <br/>
            ...
            <div>
                <div class="card text-center"><img class="card-img-top" src="images1/customer2.jpg" alt="">
                    <div class="card-body">
                        <h5>Missy Limana<br/>
                            <span> Project Manager </span></h5>
                        <p class="card-text">“ Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil
            ...
            <div>
                <div class="card text-center"><img class="card-img-top" src="images1/customer3.jpg" alt="">
                    <div class="card-body">
                        <h5>Aana Brown<br/>
                            <span> Project Manager </span></h5>
                        <p class="card-text">“ Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil
